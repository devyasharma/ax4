...
!(function (e, t) {
  ...
  function Ve(e, t) {
    ...
    var i = t,
      ...
      E = Ye(Object.assign(Object.assign({}, y), x)),
      S = "popper" === c ? E : _,
      T = {
        ...
        if (x) {
          if (r) {
            var C = "y" === w ? te : se,
              ...
              F = H[k],
              B = Se(0, E[D], j[D]),
              Y = b ? E[D] / 2 - L - B - N - T : P - B - N - T,
              R = b ? -E[D] / 2 + L + B + F + T : z + B + F + T,
              ...
              X = x[w] + Y - V - G,
              $ = x[w] + R - V,
              U = Se(h ? Math.min(A, X) : A, O, h ? Math.max(I, $) : I);
            (x[w] = U), (M[w] = U - O);
          }
          if (a) {
            var J = "x" === w ? te : se,
  ...
  var st = nt(),
    rt = nt({ defaultModifiers: [Ie, Ke, Oe, he] }),
    ot = nt({ defaultModifiers: [Ie, Ke, Oe, he, Qe, Xe, Ze, Ce, Je] }),
    at = Object.freeze({
      __proto__: null,
      popperGenerator: nt,
      detectOverflow: Ve,
          ...
          l.forEach(function (e) {
            (function (e, t) {
              ...
              if (t.includes(i))
                return (
                  !xt.has(i) ||
                  Boolean(e.nodeValue.match(Et) || e.nodeValue.match(St))
                );
              for (
  ...
  j.on(
    ...
    function (e) {
      e.preventDefault(), (E(this, "bs.tab") || new qt(this)).show();
    }
  ),
    b(function () {
      var e = y();
                  ...
                  if (
                    ...
                    if ((i.metaKey && (M = !(c = 0)), M)) {
                      var O = T - c,
                        ...
                        I = A.substr(c, O).substr(1);
                      a = a.substr(0, c) + (o + I) + a.substr(c + O);
                    ...
                    s(n.mask, a)
                      ...
                      ? (this.value = n.mask.replace(/[0-9]/g, "_"))
                      : t.trigger("error_input.xdsoft");
                  } else if ((-1 !== [b, w, _, x, E].indexOf(l) && S) || -1 !== [p, f, g, h, m, y, d, v, u].indexOf(l)) return !0;
          ...
          A.find(".xdsoft_select")
            ...
            (k.setOptions = function (n) {
              ...
              (T = e.extend(!0, {}, T, n)),
                ...
                T.inline &&
                  ((N = !0), k.addClass("xdsoft_inline"), t.after(k).hide()),
                T.inverseButton &&
                      ...
                      (p = function (n, s) {
                        ...
                        (t.is("[disabled]") || P <= l || l < O) &&
                          ...
                          (T.initTime ||
                            ...
                            (T.defaultSelect || k.data("changed")
                              ? E.push("xdsoft_current")
                              : T.initTime && E.push("xdsoft_init_time")),
            ...
            k
              ...
              .on("generate.xdsoft", function () {
                T.onGenerate &&
                  ...
                  N && (k.trigger("afterOpen.xdsoft"), (N = !1));
              })
        ...
        update: {
          ...
          updateSlides: function () {
            ...
            for (let s = 0; s < h; s += 1) {
              ...
              if (
                ...
                if ("auto" === n.slidesPerView) {
                  ...
                  (D = (o - (n.slidesPerView - 1) * S) / n.slidesPerView),
                    n.roundLengths && (D = Math.floor(D)),
            ...
            if (
              ...
              (m = t),
                Math.floor(e.virtualSize - o) - Math.floor(m[m.length - 1]) >
        ...
        events: {
          attachEvents: function () {
            ...
            (e.onTouchStart = I.bind(e)),
              ...
              (e.onClick = W.bind(e)),
              (e.onLoad = H.bind(e)),
              N || (t.addEventListener("touchstart", F), (N = !0)),
              B(e, "on");
          },
    ...
    const re = [
      ...
      function (e) {
        ...
        function C(e) {
          ...
          let s, r, a, l, d, u, p, v, y, w, _, x, E, S, T, M, C, k;
          t.params.cssMode &&
            ((t.wrapperEl.style.overflow = "hidden"),
          ...
          1 === c && D && ((s = void 0), (r = void 0)),
            ...
            !e || (1 === c && D)
              ...
              : ((C = h.slideEl.offsetWidth),
                ...
                (_ = y * i.scale),
                (x = w * i.scale),
                (E = Math.min(C / 2 - _ / 2, 0)),
                (S = Math.min(k / 2 - x / 2, 0)),
                (T = -E),
                (M = -S),
                (p = d * i.scale),
                (v = u * i.scale),
      ...
      function (e) {
        ...
        o("init", () => {
          ...
          o("beforeTransitionStart", (e, t, i) => {
            !s.destroyed &&
              s.autoplay.running &&
              (i || !s.params.autoplay.disableOnInteraction ? S(!0, !0) : E());
          }),
          o("sliderFirstMove", () => {
            !s.destroyed &&
              s.autoplay.running &&
          ...
          Object.assign(s.autoplay, { start: x, stop: E, pause: S, resume: T });
      },
      function (e) {
